...
public class Queen extends Figures {
    ...
    public Queen(int x, int y, boolean own) {
        super(x, y, fig.QUEEN, own);
        if (isOwn()) {
            sprite = new ImageView(new Image("org/kore/myjavafx/fxml/sprites/wQ.png"));
        } else {
            sprite = new ImageView(new Image("org/kore/myjavafx/fxml/sprites/bQ.png"));
        }
        sprite.setX(x * 60 - 10);
